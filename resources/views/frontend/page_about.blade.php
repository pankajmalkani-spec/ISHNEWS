      ...
      <div class="row">
        <div class="col-lg-12">
              ...
              <div class="video-playlist__list">
                <a href="https://www.youtube.com/embed/MqakY4eovu8?feature=oembed&amp;autoplay=1" class="video-playlist__list-item video-playlist__list-item--active">
                  <div class="video-playlist__list-item-thumb">
                    <img data-src="https://i.ytimg.com/vi/MqakY4eovu8/default.jpg" src="{{ \App\Support\FrontendMedia::coverImageUrl(null) }}" class="video-playlist__list-item-img lazyload" alt="">
                  </div>
                ...
                <a href="https://www.youtube.com/embed/_LaE6SgEz-w?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
                  <div class="video-playlist__list-item-thumb">
                    <img data-src="https://i.ytimg.com/vi/_LaE6SgEz-w/default.jpg" src="{{ \App\Support\FrontendMedia::coverImageUrl(null) }}" class="video-playlist__list-item-img lazyload" alt="">
                  </div>
                  <div class="video-playlist__list-item-description">
                ...
                <a href="https://www.youtube.com/embed/O32Xf1fiSjU?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
                  <div class="video-playlist__list-item-thumb">
                    <img data-src="https://i.ytimg.com/vi/O32Xf1fiSjU/default.jpg" src="{{ \App\Support\FrontendMedia::coverImageUrl(null) }}" class="video-playlist__list-item-img lazyload" alt="">
                  </div>
                  <div class="video-playlist__list-item-description">
                ...
                <a href="https://www.youtube.com/embed/V67JWMGVnAE?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
                  <div class="video-playlist__list-item-thumb">
                    <img data-src="https://i.ytimg.com/vi/V67JWMGVnAE/default.jpg" src="{{ \App\Support\FrontendMedia::coverImageUrl(null) }}" class="video-playlist__list-item-img lazyload" alt="">
                  </div>
                  <div class="video-playlist__list-item-description">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="box-holder">
                  ...
                  <img src="{{ url('/images/box-about-problem.jpg') }}" alt="The Problem">
              ...
              <div class="col-sm-6">
                <div class="box-holder">
                  ...
                  <img src="{{ url('/images/box-about-solution.jpg') }}" alt="The Solution">
          ...
          <div class="team-box">
            ...
            <div class="row">
              <div class="col-md-4">
                <img src="{{ url('/images/box-news-on-tv.jpg') }}" alt="ISH News on TV">
              ...
              <div class="col-md-4">
                <img src="{{ url('/images/box-interpret-your-content.jpg') }}" alt="Interpret your content">
              ...
              <div class="col-md-4">
                <img src="{{ url('/images/box-brand-advertising.jpg') }}" alt="ISH News Advertises Your Brand">
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="single-post">
            ...
            <img src="{{ url('/images/box-youytube-creator-award-2021.jpg') }}" alt="ISH News Wins YouTube Creator Award 2021">
          </div>
        </div>
